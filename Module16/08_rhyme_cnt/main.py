...
while len(people) != 1:
    ...
    count = ?
    # TODO, возмодно, сначала стоит рассчитать индекс, а потом удалить =)
    #  Как вариант, можем взять остаток от деления текущей длины списка "текущее число" + "число в считалочке".
