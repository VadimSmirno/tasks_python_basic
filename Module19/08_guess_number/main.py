...
# TODO, предлагаю создать множество "допустимых чисел" от 1 до числа пользователя включительно.
#  И сокращать/изменять его исходя из ответа пользователя.
#  Если в мжнестве "допустимых чисел" осталось только 1 число, из цикла выходим.
